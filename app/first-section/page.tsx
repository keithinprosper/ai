    ...
    <section className="md:pb-20 pb-5 bg-gradient-to-r from-gray-00 to-gray-200 space-y-10 relative">
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="relative inline-block">
          <div className="bg-orange-100 rounded-lg mb-5 text-sm md:text-md uppercase tracking-wider font-bold text-orange-500 inline-block px-4 py-2 relative z-10">
        ...
        {/* Main Heading */}
        <div className="text-4xl md:text-7xl flex justify-center font-bold pb-4 md:pb-8 text-gradient bg-gradient-to-r from-orange-700 to-red-300 bg-clip-text text-transparent">
          Professional AI Headshots in minutes.
        </div>
        <div className="text-center justify-center items-center flex">
          <p className="text-lg md:text-2xl md:px-44 font-md tracking-wider max-w-6xl">
        ...
        <div className="flex flex-wrap gap-2 md:gap-4 justify-center pt-8">
          <Link href="/login">
            <button className="flex gap-2 md:gap-3 items-center text-center bg-orange-700 hover:bg-orange-800 font-medium text-white px-4 md:px-6 py-2 rounded-lg text-base md:text-lg transition transform motion-reduce:transition-none motion-reduce:hover:transform-none">
              Get Your Headshots
              {<FaPaintBrush />}
            </button>
          </Link>
