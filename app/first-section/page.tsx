  ...
  return (
    <section className="md:pb-20 pb-5 bg-gradient-to-r from-gray-00 to-gray-200 space-y-10 relative">
      <div className="container mx-auto text-center">
        ...
        {/* Main Heading */}
        <div className="text-7xl flex justify-center font-bold pb-10 text-gradient bg-gradient-to-r from-orange-700 to-red-300 bg-clip-text text-transparent">
          Professional AI Headshots in minutes.
        </div>
        <p className="text-2xl md:text-2xl md-10 md:px-44 bg-gradient-to-r from-black to-gray-400 bg-clip-text text-transparent font-bold">
        ...
        <div className="flex gap-4 justify-center pt-10">
          <Link href="/login">
            <button
              className="flex gap-3 items-center text-center bg-orange-700 hover:bg-orange-800 font-bold text-white px-6 py-2 rounded-md text-lg 
