...
To deploy Framecast AI to production, we're using [Git](https://git-scm.com/). A free and open-source distributed
...
<figure>
  <>![Framecast AI](../../../assets/docs/9.png)</>
  <figcaption>
    Post pushing of codebase on GitHub via Git as seen on a terminal window.
  </figcaption>
</figure>
