...
The Regular License is perfect if you’re creating something for personal use or a client project where there’s no direct revenue generation involved. This means you or your client can use Framecast AI for one end product without charging users for it.
...
- Full access to Framecast AI’s powerful features.
...
- Use Framecast AI in one paid project that’s scalable and profit-generating.
...
<div className="mt-4">
  <i>
    Turn Framecast AI into a revenue-generating machine with the Extended
    License.
  </i>
</div>
