...
CREATE TABLE IF NOT EXISTS "public"."credits" (
    ...
    "credits" integer DEFAULT 1 NOT NULL, -- Set default value to 1
...
-- Setting up the trigger function and a default credit value of 1 for all users
-- Create or update the trigger function
CREATE OR REPLACE FUNCTION public.handle_new_user()
RETURNS trigger AS $$
BEGIN
  -- Insert into the credits table with default credits value (e.g., 1)
